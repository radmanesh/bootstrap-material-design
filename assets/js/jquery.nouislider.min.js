...
(function(c) {
    ...
    function r(a) {
        ...
        c(u).each(function(c, n) {
            if (void 0 === a[n])
                ...
                throw Error("(Format) 'format." + n + "' must be a " + typeof A[c] +
                ".");
        });
        m(h, "mark", "thousand");
        m(h, "prefix", "negative");
    ...
    k.prototype.p = function(a, h, d, k) {
        ...
        this.update=!k;
        if ("string" ===
        typeof a && 0 === a.indexOf("-tooltip-"))
            this.K(a, h);
        else if ("string" === typeof a && 0 !== a.indexOf("-"))
            this.H(a);
    ...
    k.prototype.write = function(a, c, d, k) {
        if (!this.update ||!1 !== k)
            ...
            this.format(a), "function" === typeof this.method)
...
(function(c) {
    ...
    function h(a, b) {
        for (var c = 1, g; (a.dir ? 100 - b : b) >= a.c[c];)
            c++;
        if (a.m)
            return g = a.c[c - 1], c = a.c[c], b - g > (c - g) / 2 ? c : g;
    ...
    function N(a, b, d) {
        ...
        c.each(a.o, function(a, e) {
            if (!c.isArray(e))
                throw Error("noUiSlider: 'serialization." + (a ? "upper" : "lower") + "' must be an array.");
            c.each(e, function() {
                if (!(this instanceof c.Link))
                    throw Error("noUiSlider: 'serialization." + (a ? "upper" : "lower") + "' can only contain Link instances.");
                this.I(a);
                this.J(d);
                this.q(b.format)
            })
    ...
    function O(a, b) {
        ...
        c.each(g, function(c, d) {
            if (void 0 === a[c]) {
                if (d.e)
                    throw Error("noUiSlider: '" + c + "' is required.");
                return !0
            }
            d.f(f, a[c], b)
        });
    ...
    function V(d, b, m) {
        ...
        function u(d, p, e) {
            ...
            if (p === x[g])
                return 1 === l.length?!1 : p === H || p === k ? 0 : !1;
            d.css(b.style, p + "%");
        ...
        function w(a, c, d, e) {
            ...
            c.on(a, function(a) {
                ...
                if (q.hasClass(f[14]) || void 0 !== c && null !== c)
                    return !1;
                a.preventDefault();
                ...
                if (p || F)
                    F || void 0 !== window.pageXOffset || (window.pageXOffset = document.documentElement.scrollLeft, window.pageYOffset =
